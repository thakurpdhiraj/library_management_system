...
insert into book_order(user_id,book_id,book_reference_id,ordered_at,return_by,collected_at,returned_at,collect_by)
values (2,2,'2b-1c-def',DATEADD('DAY',-6, CURRENT_DATE),DATEADD('MONTH',1, CURRENT_DATE),null,null,DATEADD('DAY',3, CURRENT_DATE));
...
insert into book_order(user_id,book_id,book_reference_id,ordered_at,return_by,collected_at,returned_at,collect_by)
values (2,3,'3b-2c-def',DATEADD('DAY',-5, CURRENT_DATE),DATEADD('DAY',25, CURRENT_DATE),DATEADD('DAY',-3, CURRENT_DATE),null,DATEADD('DAY',-2, CURRENT_DATE));
...
insert into book_order(user_id,book_id,book_reference_id,ordered_at,return_by,collected_at,returned_at,collect_by)
values (2,1,'1b-1c-def',DATEADD('DAY',-10, CURRENT_DATE),DATEADD('DAY',-1, CURRENT_DATE),DATEADD('DAY',-4, CURRENT_DATE),null,DATEADD('DAY',-3, CURRENT_DATE));


insert into book_order_history(order_id, user_id, book_id, book_reference_id, ordered_at, collected_at, returned_at)
values (1,2,1,'1b-1c-def',DATEADD('DAY',-30, CURRENT_DATE),DATEADD('DAY',-27, CURRENT_DATE),DATEADD('DAY',-25, CURRENT_DATE));
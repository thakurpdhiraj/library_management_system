...
values (3,2,'2b-1c-1',DATEADD('DAY',-7, CURRENT_DATE),DATEADD('MONTH',1, CURRENT_DATE),null,null,DATEADD('DAY',3, CURRENT_DATE),'978-844-89-8416-8','Java');
...
insert into book_order(user_id,book_id,book_reference_id,ordered_at,return_by,collected_at,returned_at,collect_by,book_isbn,book_name)
values (3,4,'4b-2c-1',DATEADD('DAY',-7, CURRENT_DATE),DATEADD('DAY',25, CURRENT_DATE),null,null,DATEADD('DAY',-3, CURRENT_DATE),'979-199-640-416-3','Harry Potter 2');
...
insert into book_order(user_id,book_id,book_reference_id,ordered_at,return_by,collected_at,returned_at,collect_by,book_isbn,book_name)
values (3,3,'3b-2c-1',DATEADD('DAY',-7, CURRENT_DATE),DATEADD('DAY',25, CURRENT_DATE),DATEADD('DAY',-3, CURRENT_DATE),null,DATEADD('DAY',-2, CURRENT_DATE),'978-70-17269-98-9','Harry Potter 1');
...
values (1,2,1,'1b-1c-2',DATEADD('DAY',-30, CURRENT_DATE),DATEADD('DAY',-27, CURRENT_DATE),DATEADD('DAY',-25, CURRENT_DATE),'979-7690-7873-6-6','Data Structure and Algorithm');